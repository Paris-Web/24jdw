	...
	<header class="post-header">
		...
		<div class="post-aside post-aside--start">
			<p class="post-metas">
				...
				<span class="post-meta post-meta--length"><span aria-label="Temps de lecture&nbsp;: environ">~</span>&nbsp;<?php jdw_the_reading_time(); ?></span>
			</p>
		</div>
		<div class="post-aside post-aside--end">
			<p class="post-meta post-meta--share">Partager&nbsp;: <a class="post-share-link post-share-link--facebook" href="https://www.facebook.com/sharer.php?u=<?php the_permalink(); ?>" title="Partager cet article sur Facebook" onClick="_gaq.push(['_trackEvent', 'Partage', 'Partager sur Facebook', '<?php the_title_attribute('echo=0'); ?>']);">Facebook</a><a class="post-share-link post-share-link--twitter" href="http://www.twitter.com/share?text=<?php echo esc_attr(get_the_title().' (via @24joursdeweb)')?>&url=<?php echo get_permalink(); ?>" title="Partager cet article sur Twitter" onClick="_gaq.push(['_trackEvent', 'Partage', 'Partager sur Twitter', '<?php the_title_attribute('echo=0'); ?>']);">Twitter</a></p>
			<?php if(get_comments_number() > 0): ?>
			<p class="post-meta post-meta--comments">
				<a class="post-comments-link" href="#commentaires" onClick="_gaq.push(['_trackEvent', 'Anchor Link', 'Commentaires', '<?php the_title_attribute('echo=0'); ?>']);"><u>Commentaires</u> (<?php echo get_comments_number(); ?>)</a>
			</p>
			<?php endif; ?>
		</div>
	</header>
