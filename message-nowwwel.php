...
<div class="nowwwel-message">
	<div class="nowwwel-note">
		...
		<p><a href="http://www.hteumeuleu.fr/en-decembre-ecrivez-partagez-hashtag-nowwwel/">Découvrir l'initiative #nowwwel</a> <a href="https://www.twitter.com/search?f=tweets&vertical=default&q=%23nowwwel" class="nowwwel-button">Suivre le hashtag #nowwwel</a></p>
	</div>
</div>
<style>
	...
	.nowwwel-button { display:inline-block; font-weight:bold; margin:0 1em; padding:0.5em 1em; text-decoration:none; background:yellow; }
</style>
<?php endif; ?>